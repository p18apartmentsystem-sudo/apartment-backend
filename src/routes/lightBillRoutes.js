...
router.post("/", auth, role("flat_admin"), upload.single("proofFile"), controller.uploadLightBill);

// get bills of flat (flat_admin)
router.get("/flat", auth, role("flat_admin", "resident"), controller.getFlatLightBills);
...
router.get("/:id", auth, role("apartment_admin", "flat_admin", "resident"), controller.getLightBillPaymentById);
